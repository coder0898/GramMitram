...
const ServiceTable = ({ services, role, onView, onApply, disableApply }) => {
  return (
              ...
              <TableCell>
                ...
                {role === "user" && (
                  ...
                  <Button
                    ...
                    sx={{ ml: 1 }}
                    onClick={() => onApply(service)}
                    disabled={disableApply && disableApply(service)} // use disableApply
                  >
                    {disableApply && disableApply(service)
                      ? "Applied"
                      : "Apply"}{" "}
                    // update text
                  </Button>
